    ...
    <div class="bg-gray-50 dark:bg-black p-10 flex items-center justify-center">
        <div class="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl border max-w-xl">
            <div class="flex justify-between">
                ...
                <svg class="text-blue-400 dark:text-white h-6 w-auto inline-block fill-current" viewBox="0 0 24 24">
                    <g>
                        <path
            ...
            <p class="text-black dark:text-white block text-xl leading-snug mt-3">{{ post }}</p>
            ...
            <div class="text-gray-500 dark:text-gray-400 flex mt-3">
                <div class="flex items-center mr-6">
                    <button @click="likeitem(id)">
                        <svg class="fill-current h-5 w-autor-1re7ezh r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
                            viewBox="0 0 24 24">
                            <g>
                                <path
                    ...
                    <span class="ml-3">{{ likes.length }}</span>
                </div>
        ...
        <div class="flex items-center mr-6">
                  ...
                  <Comments :posts_id="id" :comments="comments"/>
              </div>
    </div>
</div></template>
